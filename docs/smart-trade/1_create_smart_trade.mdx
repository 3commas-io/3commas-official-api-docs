...
Details of the Leverage applied to this SmartTrade.
  <CollapsibleNestedParams>
    ...
    <ApiParam name='value' type="integer" id="value">
      Cross or isolated leverage value. Leverage value is dependent on the exchange. It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
    </ApiParam>
   </CollapsibleNestedParams>
</ApiParam>
  ...
  <CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      <ApiParam name="value" type="string" id="value" required>
        Amount of units for position trade. It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
      </ApiParam>
    </CollapsibleNestedParams>
