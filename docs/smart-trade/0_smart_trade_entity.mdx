...
<CollapsibleApiParam name="position" type="object" id="position">
  ...
  <CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      ...
      <ApiParam name="editable" type="boolean" id="editable">
        Indicates whether the user can modify the value of unit when editing
        SmartTrade `true` or not `false`.
      </ApiParam>
    </CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      ...
      <ApiParam
        name="value_without_commission"
        type="number"
        id="value_without_commission"
      >
        The price of the position order, excluding commission.
      </ApiParam>
      <ApiParam name="editable" type="boolean" id="editable">
        Indicates whether the user can modify the group of price settings
        parameters when editing SmartTrade
      </ApiParam>
    </CollapsibleNestedParams>
    <ApiParam name="total" type="number" id="total">
      The total value of the position, including all relevant factors such as
      price and quantity
    </ApiParam>
    <ApiParam name="order_type" type="string" id="order_type">
      The type of order used to open the position: `market`, `limit`,
      `conditional`
    </ApiParam>
    <ApiParam name="status" type="object">
      Provides detailed information about the status of this Position. The
      status is automatically assigned by 3Commas
    </ApiParam>
    <CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      <ApiParam name="editable" type="boolean" id="editable">
        Indicates whether the user can modify the settings of conditional of
        position when editing SmartTrade
      </ApiParam>
      <ApiParam name="order_type" type="string" id="order_type">
        The type of conditional order used to open the position: `market`,
        `limit`, `conditional`
      </ApiParam>
...
<CollapsibleApiParam name="stop_loss" type="object">
  ...
  <CollapsibleApiParam name="price_type" type="string" id="price_type">
    The price type for the stop loss trade(s) that was set when creating the
    SmartTrade. Can be either `value` or `percentage`
    <ApiParam name="breakeven" type="boolean" id="breakeven">
      Indicates whether the stop loss has been set at the breakeven point `true`
      or not `false`.
    </ApiParam>
    <ApiParam name="order_type" type="string" id="order_type">
    ...
    <ApiParam name="editable" type="boolean" id="editable">
      Indicates whether the stop loss settings for this SmartTrade can be
      edited.
    </ApiParam>
    <ApiParam name="price" type="object" id="price">
      ...
      <CollapsibleNestedParams>
        ...
        <ApiParam name="percent" type="number" id="percent">
          The specific percentage of the price set to trigger this Stop Loss
          trade.
        </ApiParam>
      </CollapsibleNestedParams>
    </ApiParam>
    ...
    <ApiParam name="conditional" type="object" id="conditional">
      Details of the conditional Stop Loss settings, including trailing and
      ...
      <CollapsibleNestedParams>
        ...
        <CollapsibleNestedParams>
          <ApiParam name="type" type="string" id="type">
            The type of price for the stop loss order used to close the
            position.
          </ApiParam>
          <ApiParam name="value" type="number" id="value">
            The specific price value set to trigger the stop loss order.
  ...
  <CollapsibleApiParam name="steps" type="array" id="steps">
    ...
    <CollapsibleNestedParams>
      ...
      <CollapsibleApiParam name="status" type="object" id="status">
        <p>
          Detailed information about the status and any errors for a single
          Reduce Funds step
        </p>
        <CollapsibleNestedParams>
          <ApiParam name="basic_type" type="string" id="basic_type">
      ...
      <CollapsibleApiParam name="total" type="object" id="total">
        ...
        <CollapsibleNestedParams>
          <ApiParam name="value" type="number" id="value">
            The total value of the reduce funds trade, including all relevant
            factors such as price and quantity.
          </ApiParam>
        </CollapsibleNestedParams>
      </CollapsibleApiParam>
      <CollapsibleApiParam name="data" type="object" id="data">
        ...
        <CollapsibleNestedParams>
          <ApiParam name="cancelable" type="boolean" id="cancelable">
            Indicates whether the reduce funds trade can be canceled `true` or
            not `false`.
          </ApiParam>
          <ApiParam
            name="panic_sell_available"
            type="boolean"
            id="panic_sell_available"
          >
