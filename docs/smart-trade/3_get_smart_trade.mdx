...
<NoContentEndpoint method="GET" endpoint="/v2/smart_trades/12345678" />
...
If successful, the response includes a copy of the [SmartTrade](/smart-trade/0_smart_trade_entity.mdx) entity.
