---
id: available-reduce-funds
title: Available reduce funds
...
<Informer variant="info">
  The endpoint is available for SmartTrades with status **waiting_targets**. Use
  the endpoint Get SmartTrade to check a status SmartTrade.
</Informer>
...
<StickyLayout.Root>
        ...
        <NoContentEndpoint method="GET" endpoint="/v2/smart_trades/12345678/reduce_funds_info" />
