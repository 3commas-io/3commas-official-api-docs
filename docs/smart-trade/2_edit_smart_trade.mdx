    ...
    <ApiParam name="units" type="object" id="units">
      ...
      <CollapsibleNestedParams>
        <ApiParam name="value" type="number" id="value">
          ...
          It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
        </ApiParam>
      </CollapsibleNestedParams>
