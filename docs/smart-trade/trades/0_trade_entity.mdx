...
<ApiParam name="average_price" type="string or null" id="average_price">
  The weighted average price at which the asset was bought or sold during the
...
>
  Percentage of the step in Take Profit. This field is only filled if
  `trade_purpose` is `take_profit`.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="realised_amount"
  type="string or null"
  id="realised_amount"
>
...
<CollapsibleApiParam
  name="realised_percentage"
  type="number"
  id="realised_percentage"
>
...
<CollapsibleApiParam name="trade_purpose" type="string" id="trade_purpose">
  ...
  <CollapsibleNestedParams
    ...
    collapsedName="Show allowed values"
  >
    * position; * take_profit; * stop_loss; * reduce_funds.
  </CollapsibleNestedParams>
</CollapsibleApiParam>
...
<CollapsibleApiParam
  name="trailing_last_price"
  type="string or null"
  id="trailing_last_price"
>
  Indicates the last price used for trailing.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="trailing_last_price_updated_at"
  type="number or null"
  id="trailing_last_price_updated_at"
>
...
<CollapsibleApiParam
  name="trigger_price_percentage"
  type="string or null"
  id="trigger_price_percentage"
>
