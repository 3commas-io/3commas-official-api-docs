---
id: closes-trade-by-market
title: Closes trade by market
...
<Informer variant="warning">
  The endpoint is available for Take Profit Trades for the statuses
  **to_process**, **order_placed**, and **trailing_activated**.
</Informer>
...
<StickyLayout.Root>
    ...
    <NoContentEndpoint method="POST" endpoint="/v2/smart_trades/12345678/trades/1047934729/close_by_market" />
...
<StickyLayout.Root>
    <StickyLayout.Main>
        ## Response Parameters
        If successful, the response includes a copy of the updated [SmartTrade](/smart-trade/0_smart_trade_entity.mdx) entity.
    </StickyLayout.Main>
    <StickyLayout.Sticky>
        ## Example Response
