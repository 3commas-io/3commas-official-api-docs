...
<Informer variant="info">
  ...
  **ver1/accounts/summary/pie_chart_data** endpoint to retrieve aggregated data
  for all accounts where **available_include_in_summary** is set to **true**.
</Informer>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/accounts/32402783/pie_chart_data"
/>
