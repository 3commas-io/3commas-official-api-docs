---
id: user-balances-for-table-chart-visualization
title: User balances for table chart visualization
...
<Informer variant="info">
  By replacing **account_id** with **summary**, you can use the
  **ver1/accounts/summary/account_table_data** endpoint to retrieve aggregated
  data for all accounts where **available_include_in_summary** is set to
  **true**.
</Informer>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/accounts/12345678/account_table_data"
/>
...
<CollapsibleApiParam name='position_type' type='string' id='position_type'>
  Specifies the type of position held for this currency: `long`, `short` or `null` (0).
</CollapsibleApiParam>
