...
By replacing **account_id** with **summary**, you can use the **/v2/smart_trades/summary** endpoint to retrieve aggregated data for all accounts where **available_include_in_summary** is set to **true**.
</Informer>
