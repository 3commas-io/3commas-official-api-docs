...
<Informer variant="info">
  ...
  **/ver1/accounts/summary** endpoint to retrieve aggregated data for all
  accounts where **available_include_in_summary** is set to **true**.
</Informer>
...
<NoContentEndpoint method="GET" endpoint="/ver1/accounts/12345678" />
