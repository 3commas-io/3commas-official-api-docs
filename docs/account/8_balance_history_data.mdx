...
<Informer variant="info">
  ...
  **/ver1/accounts/summary/balance_chart_data** endpoint to retrieve aggregated
...
<ApiParam name="date_to" type="integer" id="date_to">
...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/accounts/12345678/balance_chart_data?date_from=2024-09-18T18:58:55.469Z"
/>
