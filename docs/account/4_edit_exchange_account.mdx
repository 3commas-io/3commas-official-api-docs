...
<CollapsibleApiParam name="customer_id" type="string" id="customer_id">
  Unique customer ID provided by the Bitstamp exchange. This parameter is
  required when `type` is set to `Bitstamp`.
</CollapsibleApiParam>

<CollapsibleApiParam name="passphrase" type="string" id="passphrase">
  Secret phrase from this exchange account. This parameter is required when
  `type` is set to `Coinbase`.
</CollapsibleApiParam>

<CollapsibleApiParam name="address" type="string" id="address">
  Address of wallet. This parameter is required when `type` is set to
  `ethereumwallet`.
</CollapsibleApiParam>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/accounts/update?account_id=12345678&name=New%20name%20exchange"
/>
