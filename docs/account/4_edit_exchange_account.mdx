...
<ApiParam name='passphrase' type='string' id="passphrase">
  Secret phrase from this exchange account. Required for OKX, Kucoin, Bitget.
</ApiParam>
...
Use the [Supported markets list](/docs/market-data/0_supported_markets_list.mdx) endpoint to check the required parameters: **api_key**, **secret**, **customer_id**, **passphrase** in the **form_fields.required** block in this request for selecting an exchange.
</Informer>
...
```json title="POST /ver1/accounts/update"
{
  "account_id": 12345678,
  "api_key": "...",
  "secret": "..."
