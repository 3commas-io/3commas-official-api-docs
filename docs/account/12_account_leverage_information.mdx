...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/accounts/32833910/leverage_data?pair=USDC_DOGE"
/>
...
<ApiParam name="name" type="boolean" id="name">
  Display name for the leverage type.
</ApiParam>
<ApiParam
  name="can_set_leverage_value"
  type="boolean"
  id="can_set_leverage_value"
>
...
<ApiParam
  name="available_leverage_values"
  type="array"
  id="available_leverage_values"
>
