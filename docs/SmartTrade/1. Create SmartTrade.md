...
|**`instant`**  | <mark style="color:grey;background-color:white">boolean	| No | `false`<br>`true` | Use for creating Simple Buy or Simple Sell. One of the values ​can be specified: `false` or `true` for creating Simple Buy and Simple Sell |
