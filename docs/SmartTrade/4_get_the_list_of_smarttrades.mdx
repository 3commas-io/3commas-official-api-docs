...
<StickyLayout.Root>
   ...
   ## Query Parameters
        ...
        Use endpoint [User connected exchanges and wallets list](/docs/Account/5.%20List%20of%20connected%20exchanges%20and%20wallets.mdx) to get value for parameter.
        </ApiParam>
...
<StickyLayout.Sticky>
    ## Example Request
    ```
    GET /v2/smart_trades?type=smart_trade&order_by=status&from=2022-01-01T00:00:00.000Z&to=2023-01-01T00:00:00.000Z
    ```
</StickyLayout.Sticky>
</StickyLayout.Root>
...
<StickyLayout.Root>
    <StickyLayout.Main>
        ## Response Parameters 
        If successful, the response will contain an array of [SmartTrade](0.%20SmartTrade%20entity.mdx) entities.
    </StickyLayout.Main>
    <StickyLayout.Sticky>
## Example Response
<ResponseTabs.Root>
