**Description:** Cancels an existing SmartTrade in place using its ID
...
<mark style={{ color: "red", backgroundColor: "white" }}> **DELETED**</mark>

<mark style={{ color: "red", backgroundColor: "white" }}>`/v2/smart_trades/{id}`</mark>
