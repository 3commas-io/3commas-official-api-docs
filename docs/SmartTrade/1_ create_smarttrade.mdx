...
<ApiParam name='pair' type='string' id="pair" required>
    Trading pair in 3Commas format. Use endpoint [All market pairs](/docs/Market%20data/All%20market%20pairs.md) to get value for parameter.
</ApiParam>
  ...
  <CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      <ApiParam name="value" type="string" id="value" required>
        Amount of units for position trade. It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/docs/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
      </ApiParam>
    </CollapsibleNestedParams>
