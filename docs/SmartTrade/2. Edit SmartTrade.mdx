...
Details of the Leverage applied to this SmartTrade.
  <CollapsibleNestedParams>
    <ApiParam name='enabled' type="boolean" id="enabled" required>
     Sets leverage settings for a SmartTrade created on a futures account (`true` or `false`).
     Default: `false`.
    </ApiParam>
    ...
    <ApiParam name='value' type="integer" id="value">
        Cross or isolated leverage value. Leverage value is dependent on the exchange. It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/docs/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
    </ApiParam>
  </CollapsibleNestedParams>
</ApiParam>
  ...
  <CollapsibleNestedParams>
    <ApiParam name="units" type="object" id="units">
      ...
      <CollapsibleNestedParams>
        <ApiParam name="value" type="number" id="value">
          ...
          It should be based on [the rules of the exchange regarding currency rates, limits, and leverage data](/docs/Market%20data/4.%20Currency%20rates%20and%20limits%20with%20leverage%20data.mdx).
        </ApiParam>
      </CollapsibleNestedParams>
    ...
    <CollapsibleNestedParams>
      <ApiParam name="order_type" type="string" id="order_type">
        The type of position trade for this SmartTrade. Possible values: `market`, `limit`, or `conditional`.
      </ApiParam>
      <ApiParam name="price" type="object" id="price">
        TBD
      </ApiParam>
      <CollapsibleNestedParams>
        <ApiParam name="type" type="string" id="type">
          The type of price for using for this conditional order.
        </ApiParam>
        <ApiParam name="value" type="number" id="value">
...
<StickyLayout.Main>
  ## Parameters response
  If successful, the response includes an updated copy of [SmartTrade](/docs/SmartTrade/1.%20SmartTrade%20entity.md) entity.
</StickyLayout.Main>
