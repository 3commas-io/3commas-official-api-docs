...
<StickyLayout.Main>
## Response Parameters
If successful response, the response includes a copy of Trade entity. You can find a total description of all attributes on the page about [Trade](0.%20Trade%20entiry.mdx).
</StickyLayout.Main>
<StickyLayout.Sticky>
## Example Responses
<ResponseTabs.Root>
