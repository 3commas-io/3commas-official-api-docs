...
<ApiParam name='market_code' type='integer' id="market_code" required>
    ...
    Use endpoint [Supported markets list](/docs/Market%20data/1.%20Supported%20markets%20list.md) to get value for parameter `market_code`.
</ApiParam>

<ApiParam name='pair' type='string' id="pair" required>
    Trading pair in 3Commas format. 

    Use endpoints [All Market Pairs](/docs/Market%20data/2.%20All%20market%20pairs.md) to get value for parameter `pair` in 3Commas format.
</ApiParam>
