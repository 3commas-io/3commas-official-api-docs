...
<ApiParam name="order_by" type="string" id="order_by">
  Field to sort results by. Allowed values: <code>pair</code>, <code>created_at</code>, <code>closed_at</code>. Default is <code>created_at</code>.
</ApiParam>
...
Returns an array of historical trade entities. See [Trade Entity](/docs/smart-trade/simple_test) for a full list of attributes.
