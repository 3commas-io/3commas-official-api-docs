...
<ApiParam name="order_by" type="string" id="order_by">
  Field to sort results by. Allowed values: <code>pair</code>, <code>created_at</code>.
...
Returns an array of active trade entities. See [Trade Entity](/smart-trade/smart-trade-entity) for a full list of attributes.
