...
<ApiParam name='pair' type='string' id="pair" required>
   Trading pair in 3Commas format. Use the [All market pairs](/docs/market-data/1_all_market_pairs.mdx) endpoint to retrieve the list of supported pairs and their format.
</ApiParam>
...
If successful, the response includes a copy of [Grid Bot](/docs/grid-bot/0_grid_bot_entity.mdx) entity.
