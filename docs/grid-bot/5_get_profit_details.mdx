...
<Informer variant="info">
  If the **from** and **to** values are not set, the response will include all
  records ordered in descending order by ID parameter.
</Informer>
...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/grid_bots/2338357/profits?from=2024-09-01T04:00:00.000Z&to=2024-10-11T03:59:59.000Z"
/>
