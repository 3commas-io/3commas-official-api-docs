...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/grid_bots/12345678/required_balances"
/>
...
<ApiParam name="missing_balance" type="object" id="missing_balance">
  The amount of funds missing in the base and quote currencies for the Grid Bot
...
<ApiParam name="required_balance" type="object" id="required_balance">
  The total amount of funds required in base and quote currencies to launch the
  Grid Bot.
  <CollapsibleNestedParams>
    <ApiParam name="base" type="object" id="base">
...
<ApiParam name="balancing_available" type="boolean" id="balancing_available">
  Indicates whether the bot can be balanced with the current available funds
  `true` or not `false`.
</ApiParam>
