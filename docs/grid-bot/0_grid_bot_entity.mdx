...
<ApiParam name="account_id" type="integer" id="account_id">
  Unique 3Commas ID of this exchange account entity where this Grid Bot was
  created.
</ApiParam>
...
>
  Action to take if the lower stop-loss is triggered: `stop_bot`,
  `stop_bot_and_buy`, or `stop_bot_and_sell` for spot exchange accounts, and
  `stop_bot_and_close_position` for futures exchange accounts.
</CollapsibleApiParam>
...
>
  Action to take if the upper stop-loss is triggered: `stop_bot`,
  `stop_bot_and_buy`, or `stop_bot_and_sell` for spot exchange accounts, and
  `stop_bot_and_close_position` for futures exchange accounts.
</CollapsibleApiParam>
...
<CollapsibleApiParam name="leverage_type" type="string" id="leverage_type">
  Shows the leverage type that was set when creating a Grid Bot: `cross`,
  `isolated`.
</CollapsibleApiParam>
...
<CollapsibleApiParam
  name="current_profit_usd"
  type="string"
  id="current_profit_usd"
>
  Current profit in USD.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="total_profits_count"
  type="string"
  id="total_profits_count"
>
...
<CollapsibleApiParam
  name="investment_quote_currency"
  type="string"
  id="investment_quote_currency"
>
...
<CollapsibleApiParam
  ...
  type="string"
  id="current_profit_loss"
>
  Current profit or loss in the base or quote currency.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="current_profit_loss_percent"
  type="string"
  id="current_profit_loss_percent"
>
