...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/accounts/currency_rates?market_code=binance&pair=BTC_ETH"
/>
...
<CollapsibleApiParam
  name="contract_strategy_name"
  type="string"
  id="stratcontract_strategy_nameegy_name"
>
...
<CollapsibleApiParam
  name="maxMarketBuyAmount"
  type="string"
  id="maxMarketBuyAmount"
>
  Maximum order size in Base currency for buy.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="maxMarketSellAmount"
  type="string"
  id="maxMarketSellAmount"
>
  Maximum order size in Base currency for sell.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="bidMultiplierDown"
  type="string"
  id="bidMultiplierDown"
>
...
<CollapsibleApiParam
  name="askMultiplierDown"
  type="string"
  id="askMultiplierDown"
>
