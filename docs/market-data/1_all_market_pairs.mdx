...
<ApiParam name="market_code" type="integer" id="market_code" required>
  Unique exchange code in the 3Commas system. Use endpoint [Supported markets
  list](/market-data/0_supported_markets_list.mdx) to get value for parameter
  `market_code`.
</ApiParam>
...
<NoContentEndpoint
  method="GET"
  endpoint="/ver1/accounts/market_pairs?market_code=binance_us"
/>
