  ...
  <Step
    ...
    description={
      <>
        ...
        <CodeBlock showLineNumbers>{`openssl genrsa`}</CodeBlock>
      </>
    }
  />
  <Step
    ...
    description={
      <>
        <p>
          Output the private key to a file, such as private.pem. You can adjust
          the key length and/or output file name as needed:
        </p>
  ...
  <Step
    ...
    description={
      <>
        ...
        <CodeBlock showLineNumbers>{`cat public.pem`}</CodeBlock>
      </>
    }
  />
</Steps>
