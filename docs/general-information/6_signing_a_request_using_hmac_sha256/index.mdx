...
**Look [here](https://developers-3commas.pages.dev/general-information/signing-a-request-using-hmac-sha256/generating-signature-hmac-sha256) for some examples.**
