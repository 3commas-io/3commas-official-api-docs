...
On the page, click the **<span style={{ color: "#13a8a1" }}>New API access token</span>** button and select the method for generating the API Key. Then, complete the form fields. If you select Self-generated, you need to provide an RSA Private Key.

<Informer variant="info">
  For instructions on how to generate an RSA Private Key, refer to the article [How to create an RSA Key pair](/general-information/4_how_to_create_an_rsa_key_pair.mdx).
</Informer>
