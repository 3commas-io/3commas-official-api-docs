...
<Endpoint url="https://api.3commas.io/public/api" />
...
_ As a query string;
_ In the request body with content type `application/x-www-form-urlencoded` or `application/json`; \* Mixed between the query string and request body.
