...
<Steps>
  <Step
    title="Get Your 3Commas API Key"
    description={
      <>
        ...
        We recommend the second method as it provides a more secure connection
        for your apps.
      </>
    }
  />
  <Step
    ...
    description={
      <>
        <code>SIGNED</code> endpoints require an additional{" "}
        <code>Signature</code> header to ensure the authenticity of the request.
      </>
    }
  />
  <Step
    title="Signed Endpoint"
    description={
      <>
        To authenticate, pass your 3Commas <code>API Key</code> and the{" "}
        <code>Signature</code> header in the request.
      </>
    }
  />
</Steps>
...
<Endpoint url="/ver1/validate" method="GET" />
