...
<ApiParam name="type" type="string" id="type">
  ...
  >
    * **long** - a strategy focused on buying low and selling high * **short** -
    a strategy focused on selling high and buying low
  </CollapsibleNestedParams>
</ApiParam>
...
<ApiParam name="strategy" type="string" id="strategy">
  ...
  <CollapsibleNestedParams
    ...
    collapsedName="Show allowed values"
  >
    * **simple** - a single strategy type * **composite** - a combination of
