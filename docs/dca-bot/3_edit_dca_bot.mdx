...
<ApiParam name='pairs' type='string' id="pairs" required>
  Trading pair(s) in 3Commas format. Use endpoint [All market pairs](/docs/market-data/1_all_market_pairs.mdx) to get value for parameter.
</ApiParam>
...
If successful, the response includes a copy of [DCA Bot](/docs/dca-bot/0_dca_bot_entity.mdx) entity.
