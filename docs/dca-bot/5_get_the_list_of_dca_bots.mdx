...
<ApiParam name='account_id' type='integer' id="account_id">
  ...
  Use endpoint [User connected exchanges and wallets list](/docs/account/5_list_of_connected_exchanges_and_wallets.mdx) to get value for parameter.
</ApiParam>
...
## Response Parameters 
  ...
  If successful, the response includes copies of the [DCA Bot](/docs/dca-bot/0_dca_bot_entity.mdx) entity.
</StickyLayout.Main>
