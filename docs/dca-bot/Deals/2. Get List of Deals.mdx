...
<ApiParam name='account_id' type='integer' id="account_id">
  ...
  Use endpoint [User connected exchanges and wallets list](Account/User%20connected%20exchanges%20and%20wallets%20list.md) to get value for this parameter.
</ApiParam>
...
If successful, the response includes a copy of [Deals](0.%20Deal%20entity.mdx) entity.
</StickyLayout.Main>
