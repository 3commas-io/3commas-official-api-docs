...
<NoContentEndpoint method="GET" endpoint="/ver1/bots/12345678/deals_stats" />
...
<ApiParam
  name="from_currency_is_dollars"
  type="boolean"
  id="from_currency_is_dollars"
>
...
<CollapsibleApiParam
  name="completed_deals_btc_profit"
  type="string"
  id="completed_deals_btc_profit"
>
  The total profit from completed deals in BTC.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="funds_locked_in_active_deals"
  type="string"
  id="funds_locked_in_active_deals"
>
  The total funds currently locked in active deals, in USD.
</CollapsibleApiParam>

<CollapsibleApiParam
  name="btc_funds_locked_in_active_deals"
  type="string"
  id="btc_funds_locked_in_active_deals"
>
