---
id: close-one-step-in-deal-at-market-price
title: Close one step in deal at market price
...
<Informer variant="warning">
  After this action, the final status **Panic_sold** will be automatically set
  by 3Commas.
</Informer>
...
<ApiParam name='trade_id' type='integer' id="trade_id" required>
  Unique 3Commas ID Trade of the deal that should be sold. Use endpoint [Get Deal](/dca-bot/deals/1_get_deal.mdx) to get value for parameter 'trade_id'.
</ApiParam>
</StickyLayout.Main>
<StickyLayout.Sticky>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/deals/12345678/panic_sell_step?trade_id=1123324654"
/>
