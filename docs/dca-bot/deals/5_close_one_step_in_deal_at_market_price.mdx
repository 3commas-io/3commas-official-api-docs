...
<ApiParam name='trade_id' type='integer' id="trade_id" required>
  Unique 3Commas ID Trade of the deal that should be sold. Use endpoint [Get Deal](/docs/dca-bot/deals/1_get_deal.mdx) to get value for parameter 'trade_id'.
</ApiParam>
</StickyLayout.Main>
<StickyLayout.Sticky>
...
If successful, the response includes an updated copy of the [Deals](/docs/dca-bot/deals/0_deal_entity.mdx) entity.
