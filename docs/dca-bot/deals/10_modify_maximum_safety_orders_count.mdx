---
id: modify-maximum-safety-orders-count
title: Modify maximum safety orders count
...
Updates a value for parameter `max_safety_orders` for a specific deal of DCA Bot using its ID.
...
<ApiParam name='max_safety_orders' type='integer' id="max_safety_orders" required>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/deals/:deal_id/update_max_safety_orders?max_safety_orders=6"
/>
