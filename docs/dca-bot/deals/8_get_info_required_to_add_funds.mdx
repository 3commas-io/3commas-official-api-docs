...
<NoContentEndpoint method="GET" endpoint="/ver1/deals/2295655961/data_for_adding_funds" />
...
## Response Parameters
<CollapsibleApiParam name="orderbook_price" type="string" id="orderbook_price">
   The current price from the exchange's order book for the pair.
</CollapsibleApiParam>

<CollapsibleApiParam name="price_per_one_unit_strategy_name" type="string" id="price_per_one_unit_strategy_name">
...
<CollapsibleApiParam name="quote_currency" type="string" id="quote_currency">
