...
<Informer variant="warning">
  After this action, 3Commas will automatically set the final status to
  **Cancelled** for this deal.
</Informer>
...
<NoContentEndpoint
  method="POST"
  endpoint="/ver1/deals/1234567890/convert_to_smart_trade?stop_bot=false"
/>
