...
<ApiParam name='account_id' type='integer' id="account_id">
  ...
  Use endpoint [User connected exchanges and wallets list](/docs/account/5_list_of_connected_exchanges_and_wallets.mdx) to get value for this parameter.
</ApiParam>
...
If successful, the response includes a copy of [Deals](/docs/dca-bot/deals/0_deal_entity.mdx) entity.
</StickyLayout.Main>
