...
<ApiParam name='order_id' type='integer' id="order_id" required>
  Unique 3Commas Trade entity ID. Use the [Get Trades of Deal](/docs/dca-bot/deals/7_get_trades_of_deal.mdx) endpoint to retrieve the value for the `order_id` parameter.
</ApiParam>   
