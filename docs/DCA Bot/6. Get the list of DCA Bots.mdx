...
<ApiParam name='account_id' type='integer' id="account_id">
  ...
  Use endpoint [User connected exchanges and wallets list](Account/User%20connected%20exchanges%20and%20wallets%20list.md) to get value for parameter.
</ApiParam>
...
<CollapsibleApiParam name="limit" type="integer" id="limit">
  Limits the number of records returned. Maximum: ` 100 `.
...
<CollapsibleApiParam name="scope" type="string" id="scope">
  Filters bots by their status. **Default: ** `null`
...
## Parameters Response 
  ...
  If successful, the response includes copies of the [DCA Bot](1.%20DCA%20Bot%20entity.mdx) entity.
</StickyLayout.Main>
