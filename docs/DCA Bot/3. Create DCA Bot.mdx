...
<CollapsibleApiParam name='max_active_deals' type='integer' id="max_active_deals">
     ...
     <p>Minimum:<code> 1 </code>, Maximum:<code>199</code>; Default: <code> 1 </code> </p>
</CollapsibleApiParam>
...
<ResponseTabs.Root>
  <ResponseTabs.TabItem value="Manual signals" label="Manual signals" default>
   ```json
[
   {
      "strategy": "manual"
...
[]
  ...
  <ResponseTabs.TabItem value="Non-stop" label="Non-stop" default>
...
```
  ...
  <ResponseTabs.TabItem value="TradingView" label="TradingView" default>
   ```json
   [
   {
      "options": {
  ...
  <ResponseTabs.TabItem value="RSI" label="RSI" default>
   ```json
      [
   {
      "options": {
