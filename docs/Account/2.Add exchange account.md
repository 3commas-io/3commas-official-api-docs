...
|------|------|-----------|-----------------|------------|
|**type** | `integer` | Yes |  | 3Commas of exchange code entity |
|**name** | `integer` | Yes |  | Name of this exchange account. |
|**api_key**  | `integer` | Yes |  | API-key from this exchange account |
|**secret**  | `integer` | Yes |  | Secret-key from this exchange account |
|**address**  | `integer` | No |  | Address of wallet. This parameter is required when `type` is set to `ethereumwallet` |
|**`customer_id**  | `integer` | No |  | Unique customer ID provided by the Bitstamp exchange.<br>This parameter is required when `type` is set to `Bitstamp` |
...
|**types_to_create**  | `integer` | No |  | Array of related account types to be created.<br> For example ['binance_margin'] |
